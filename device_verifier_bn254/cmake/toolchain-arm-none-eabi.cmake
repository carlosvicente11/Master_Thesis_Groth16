...
set(BARE_METAL_INCLUDE "${CMAKE_CURRENT_LIST_DIR}/../uvision/include")
get_filename_component(BARE_METAL_INCLUDE "${BARE_METAL_INCLUDE}" ABSOLUTE)

# -nostdinc: disable all default system include paths, then add back our
# bare-metal stubs (first, takes priority) and the GCC builtin headers
# (stddef.h, stdarg.h, ...).
execute_process(
