...
impl<T: MontConfig<N>, const N: usize> FpConfig<N> for MontBackend<T, N> {
    ...
    fn mul_assign(a: &mut Fp<Self, N>, b: &Fp<Self, N>) {
        crate::opcount::bump(core::any::type_name::<T>(), crate::opcount::Op::Mul);
        T::mul_assign(a, b)
    }

    fn sum_of_products<const M: usize>(a: &[Fp<Self, N>; M], b: &[Fp<Self, N>; M]) -> Fp<Self, N> {
        // Counts as M base-field multiplications (used by Fp2 mul, which bypasses
        // `mul_assign`); without this the extension-field muls go uncounted.
        crate::opcount::bump_mul_n(core::any::type_name::<T>(), M as u64);
    ...
    fn square_in_place(a: &mut Fp<Self, N>) {
        crate::opcount::bump(core::any::type_name::<T>(), crate::opcount::Op::Square);
        T::square_in_place(a)
    }

    fn inverse(a: &Fp<Self, N>) -> Option<Fp<Self, N>> {
        crate::opcount::bump(core::any::type_name::<T>(), crate::opcount::Op::Inverse);
        T::inverse(a)
    }
